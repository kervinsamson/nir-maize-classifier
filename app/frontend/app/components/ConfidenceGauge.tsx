...
export function ConfidenceGauge({ confidence, isHighProtein, decisionFunctionScore }: ConfidenceGaugeProps) {
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center flex-1 py-4 gap-1">
          <span
            ...
            style={{ color: isHighProtein ? '#16a34a' : '#f97316' }}
          >
            {confidence}%
          </span>
          <span
            ...
            style={{ color: isHighProtein ? '#16a34a' : '#f97316' }}
          >
            {isHighProtein ? 'High Protein' : 'Low Protein'}
          </span>
        </div>
